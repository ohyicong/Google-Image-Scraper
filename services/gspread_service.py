...
class GoogleSheetsService:
    ...
    def get_items(self, product_list_column="Product", done_column="Processed") -> List[str]:
        """
    ...
    def update_description(self, item: str, description: str, product_list_column="Product", description_column="Description", done_column="Processed") -> List[str]:
        """
        Will return the values in the product_list:column that have nothing on the done_column
        :param done_column:
        ...
        for row_index, row in enumerate(rows[1:], start=2):
            ...
            if row_dict[product_list_column] == item:
                self.wks.update_cell(row_index, headers_dict[description_column], description)
